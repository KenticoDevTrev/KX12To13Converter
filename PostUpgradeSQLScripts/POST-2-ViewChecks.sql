...
SELECT 
  TABLE_NAME COLLATE SQL_Latin1_General_CP1_CI_AS as View_Name, 'Remove From UPGRADED_XPERIENCEDB' COLLATE SQL_Latin1_General_CP1_CI_AS as Instructions
...
SELECT 
  TABLE_NAME COLLATE SQL_Latin1_General_CP1_CI_AS as View_Name, 'Add To UPGRADED_XPERIENCEDB' COLLATE SQL_Latin1_General_CP1_CI_AS as Instructions
FROM FRESH_XPERIENCEDB.INFORMATION_SCHEMA.VIEWS
EXCEPT
SELECT 
  TABLE_NAME COLLATE SQL_Latin1_General_CP1_CI_AS as View_Name, 'Add To UPGRADED_XPERIENCEDB' COLLATE SQL_Latin1_General_CP1_CI_AS as Instructions
